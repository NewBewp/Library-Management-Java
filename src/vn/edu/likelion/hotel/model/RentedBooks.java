...
public class RentedBooks {
    ...
    public RentedBooks(int id_borrower, int id_rentedBook,String name_borrower, String name_rentedBook, LocalDate borrowBook_date, LocalDate returnBook_date, int quantityRentedBook) {
